...
## GitHub-only delivery

Do not deploy this theme to Vercel. Use GitHub Actions artifacts, GitHub Release assets, or a local ZIP built from GitHub source. See `docs/GITHUB_ONLY.md`.
